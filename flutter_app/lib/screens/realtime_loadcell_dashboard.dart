    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          if (_wsService.latestReading.isNotEmpty) ...[
            Container(
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _buildSensorValue(
                          'Left Sensor',
                          _wsService.latestReading['left'] ?? 0,
                          Colors.red,
                        ),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: _buildSensorValue(
                          'Right Sensor',
                          _wsService.latestReading['right'] ?? 0,
                          Colors.green,
                        ),
                      ),
                    ],
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                'WS: ${_wsService.recentReadings.length}',
                                style: const TextStyle(
                                  color: Colors.orange,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                              ...
                              Text(
                                'Total: ${_testData.length + _wsService.recentReadings.length}',
                                style: const TextStyle(
                                  color: Colors.orange,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                            ...
                            Column(
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    '${_testData.length + _wsService.recentReadings.length} samples',
                                    style: const TextStyle(
                                      color: Colors.blue,
                                      fontWeight: FontWeight.w500,
                                    ),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index < _testData.length) {
                          ...
                          final wsIndex = index - _testData.length;
                          if (wsIndex < _wsService.recentReadings.length) {
                            return _buildDataRow(
                              _wsService.recentReadings[wsIndex],
                              index,
                            );
                          } else {
