...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final _emailController = TextEditingController(text: 'Jesper@lnu.se');
  ...
  void _handleLogin() {
    if (_formKey.currentState!.validate()) {
      ...
      developer.log(
        'Login attempt with: $email / ${password.length} chars',
        name: 'LoginScreen',
      );
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text('LOG IN', style: AppTextStyles.headerStyle),
                              const SizedBox(height: 8),
                              Container(
                                width: 135,
                                height: 1,
                          ...
                          // Mobile login layout: Add more space around the button
                          const SizedBox(height: 50),
